    ...
    <body>
        ...
        <div class="main_block">
            <form id="medicine" method="post" action="${pageContext.request.contextPath}/medicines/add">
                ...
                <br><br>
                <input class="input_block" type="text" name="name" id="name" placeholder="Metformin Hydrochloride" form="medicine">
                <br><br><br>
                <input class="submit_block" type="submit" name="submit" id="submit" value="Submit" form="medicine">
                <br><br>
                <a class="logout_block" href="${pageContext.request.contextPath}/medicines">Back</a>
            </form>
        </div>
    </body>
</html>
